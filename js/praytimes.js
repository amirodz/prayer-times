...
(function (name, global, definition) {
  ...
  PrayTimes.prototype = {
    ...
    methods: {
	  ...
	  BH: { // isha is not explicitly specified in this method
	  ...
	  TR: { // isha is not explicitly specified in this method
	   ...
	   RU: { // isha is not explicitly specified in this method
        name: 'Russia Custom',
        params: {
          fajr: 16,
          isha: 15,
	   ...
	   FR: { // isha is not explicitly specified in this method
	  ...
	  DE: { // isha is not explicitly specified in this method
        name: 'Germany Custom',
        params: {
          fajr: 18,
          isha: 16.5,
	  ...
	  ID: { // isha is not explicitly specified in this method
	  ...
	  Qatar: { // isha is not explicitly specified in this method
        name: 'Qatar',
        params: {
          fajr: 18,
          isha: '90 min',
	  ...
	  KUWAIT: { // isha is not explicitly specified in this method
        name: 'KUWAIT',
        params: {
          fajr: 18,
          isha: '17.5 min',
    ...
    getTimes: function (date, coords, timezone, dst, format) {
     ...
     // console.log('jDate:'+ new Date(date[0], date[1]- 1, date[2]));
